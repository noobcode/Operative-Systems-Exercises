 ...
 *
 */
typedef struct Node {	// struct rettangolo
    void        * data; // rettangolo_t* rett;
    struct Node * next; // struct rettangolo* next
} Node_t;	// rettangolo_t
 ...
 */
int    push(Queue_t *q, void *data); // (Queue_t* q, rettangolo_t* rett)
...
unsigned long length(Queue_t *q); //Xed
